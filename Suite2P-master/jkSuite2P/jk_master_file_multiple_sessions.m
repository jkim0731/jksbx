...
%% JK update
% 2020/02/18: for multiple sessions. Combine images from multiple sessions before ROI detection.
%             Use 'jk_make_db_multiple_sessions.m'
...
jk_make_db_multiple_sessions; % RUN YOUR OWN MAKE_DB SCRIPT TO RUN HERE
...
% multiple_session
ops0.NimgFirstRegistration  = 2000; % number of images to include in the first registration pass 
%
...
% multiple_session
ops0.nSVDforROI             = 1500; % how many SVD components for cell clustering
