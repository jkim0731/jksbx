...
imageStack = double(imageStack); % 02/11/2016 JK
...
%   observed = stackslice;
for i=2:stacksize % 02/11/16 JK
  observed = imageStack(:,:,i); % 02/11/16 JK
...
% imageStack(:,:,end)=[]; % 02/11/16 JK

imageStack = uint16(imageStack); % 02/11/2016 JK