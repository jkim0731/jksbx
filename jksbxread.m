function x = jksbxread(fname,k,N,varargin)
...
% sbxread not working, not reading anything... 02/23/16 info.fid NOT
% defined, even though there was info_loaded defined.
